...
st.warning("""PLEASE NOTE: This Streamlit app uses streamlit-webrtc to get feed from your webcam, which is not well-supported online since Streamlit Community Cloud blocks WebRTC packets. See Github for instructions on running the app locally instead: https://github.com/Nazarshia2889/EagleAI""")
